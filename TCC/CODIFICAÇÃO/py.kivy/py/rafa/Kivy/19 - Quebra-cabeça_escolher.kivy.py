...
class LearPlusApp(App):
    def build(self):
        ...
        # Imagem de fundo
        background_image = Image(source="py.kivy/py/img_wireframe\ICONS\quebra cabeca\Fundo.png", allow_stretch=True, keep_ratio=False)
        layout.add_widget(background_image)

        
          # Título facil
        title_label1 = Label(text="[color=#C985FF]Meio a meio[/color]",
                            font_size=32,
                            size_hint_y=None,
                            height=1330,
                            markup=True)
        layout.add_widget(title_label1)
          ...
          # Título medio
        title_label1 = Label(text="[color=#C985FF]Quebra-Cabeça[/color]",
                            font_size=32,
                            size_hint_y=None,
                            height=855,
                            markup=True)
