...
#+ & -
txt1 = Label(janela,text = "Meio a meio", fg="#A020F0", font=('Century Gothic',27))
txt1.place(x=100, y=15)
...
#upload
photo3 = PhotoImage(file="img_wireframe\ICONS\Matematica\Subir.png")
...
# x & /
txt1 = Label(janela,text = "Quebra-Cabeça", fg="#A020F0", font=('Century Gothic',27))
txt1.place(x=55, y=355)

#upload
photo4 = PhotoImage(file="img_wireframe\ICONS\Matematica\Subir.png")
...
photo5 = PhotoImage(file="img_wireframe\ICONS\Matematica\Subir.png")
...
photo6 = PhotoImage(file="img_wireframe\ICONS\Matematica\Subir.png")
...
photo7 = PhotoImage(file="img_wireframe\ICONS\Matematica\Subir.png")
photo7 = photo7.subsample(17, 17)
btn1 = Button(janela, bd=0,text="                  ", image= photo7, bg="#d3d3d3", compound= RIGHT , font=('Century Gothic',12))
btn1.place(x=240, y=410,width=115, height=140)

photo9 = PhotoImage(file="img_wireframe\ICONS\Matematica\Subir.png")
...
#upload
photo0 = PhotoImage(file="img_wireframe\ICONS\Matematica\Subir.png")
...
#upload
photo11 = PhotoImage(file="img_wireframe\ICONS\Matematica\Subir.png")
