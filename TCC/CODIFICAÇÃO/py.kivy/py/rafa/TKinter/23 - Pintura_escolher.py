...
#Facil
txt1 = Label(janela,text = "Animais", fg="#A020F0", font=('Century Gothic',22))
...
#Médio
txt1 = Label(janela,text = "Alimentos", fg="#A020F0", font=('Century Gothic',22))
txt1.place(x=140, y=240)
...
#Difícil
txt1 = Label(janela,text = "Cores", fg="#A020F0", font=('Century Gothic',22))
txt1.place(x=165, y=480)
